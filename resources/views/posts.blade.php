        ...
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <p>
                    ...
                    By. 
                    <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}
                    </a> 
                ...
                <a href="/posts?author={{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary"> Read more </a>
